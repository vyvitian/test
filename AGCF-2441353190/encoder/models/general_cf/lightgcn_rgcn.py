...
class lightgcn_rgcn(BaseModel):
    def __init__(self, data_handler):
        super(lightgcn_rgcn, self).__init__(data_handler)
    ...
    def init_weight(self):
        for m in self.relation_weights:
            for layer in m:
    ...
    def cal_loss(self, batch_data):
        ...
        user_embeds, item_embeds = self.forward(self.adjs, self.keep_rate)
